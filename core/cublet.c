...
static void cycle_colors (Color colors[FACE_COUNT], face_t face_a, face_t face_b, face_t face_c, face_t face_d)
{
...
void cubie_rotate_right (cubie_t *cubie) { cycle_colors(cubie->colors, FACE_FRONT, FACE_LEFT, FACE_BACK, FACE_RIGHT); }

void cubie_rotate_left (cubie_t *cubie) { cycle_colors(cubie->colors, FACE_FRONT, FACE_RIGHT, FACE_BACK, FACE_LEFT); }

void cubie_rotate_up (cubie_t *cubie) { cycle_colors(cubie->colors, FACE_FRONT, FACE_DOWN, FACE_BACK, FACE_UP); }

void cubie_rotate_down (cubie_t *cubie) { cycle_colors(cubie->colors, FACE_FRONT, FACE_UP, FACE_BACK, FACE_DOWN); }

void cubie_rotate_clockwise (cubie_t *cubie) { cycle_colors(cubie->colors, FACE_UP, FACE_LEFT, FACE_DOWN, FACE_RIGHT); }
...
static void draw_faces (const cubie_t *cubie, const Vector3 verts[FACE_COUNT][VERTICES_PER_FACE])
{
...
static void draw_borders (const Vector3 verts[FACE_COUNT][VERTICES_PER_FACE])
{
    rlBegin(RL_LINES);
...
void cubie_draw (cubie_t *cubie, Vector3 position, Vector3 rotation_axis, float rotation_angle)
{
    ...
    rlTranslatef(position.x - rotation_axis.x, position.y - rotation_axis.y, position.z - rotation_axis.z);
