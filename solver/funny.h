...
/* One of these is shown when the user asks the solver to solve a 1x1x1. */
static const char *const FUNNY_LINES[] = {
  "I am not equipped for this. Please, find someone else.",
  "I've solved millions of cubes. None of them prepared me for this.",
